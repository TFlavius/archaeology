...
<nav id="top" aria-label="Верхняя навигация">
  <a href="{{ '/ru/es2015-gstreamer/' | relative_url }}" rel="prev">← Назад: Движок, который обогнал Chrome</a> · <a href="{{ '/dragonfly-shadow-dom/' | relative_url }}" lang="en">English</a> · <strong>Русский</strong>
</nav>
...
Но веб начала двухтысячных писался вообще без приборов. Мы летели сквозь туман исключительно по пачке «Беломора».
...
В то время, когда Opera Presto был закрыт, технология существовала только в виде пары ранних черновиков. Успей разработчики его реализовать — всю работу пришлось бы выбросить. Сейчас же можно посмотреть, к чему эволюционно пришли WebKit/Blink/Gecko: это явные области дерева и специализированные обходы в них.
...
<nav aria-label="Нижняя навигация">
  <a href="#top">↑ Наверх</a> · <a href="{{ '/dragonfly-shadow-dom/' | relative_url }}" lang="en">English</a> · <strong>Русский</strong>
</nav>
