...
<nav id="top" aria-label="Верхняя навигация">
  <a href="{{ '/ru/css/' | relative_url }}" rel="prev">← Назад: Движок, которому нужен CSS</a> · <a href="{{ '/es2015-gstreamer/' | relative_url }}" lang="en">English</a> · <strong>Русский</strong>
</nav>
...
- **[XXII. Шаг назад, два шага вперёд](#xxii-шаг-назад-два-шага-вперёд)**
  ...
  - [XXII.V «Небольшая формальность»](#xxiiv-небольшая-формальность)
  - [XXII.VI Что теперь умеет Carakan?](#xxiivi-что-теперь-умеет-carakan)
...
Самой трудной отдельной возможностью оказались не классы, не модули и даже не Proxy. Ею стали proper tail calls — правильные хвостовые вызовы.
...
### XXII.VI Что теперь умеет Carakan?
...
И вот тут я пока не знаю, что пообещать. Из очевидного — полировка ES6, шороховатостей ещё предостаточно. Очень вероятно — Shadow DOM. Какие-то попутные улучшения CSS — наверняка, но вряд ли что-то крупное.
